...
export default {
    ...
    aboutMeSub: `I am proficient in front-end technologies such as HTML5, CSS3, and JavaScript, with a strong focus on responsive and user-friendly design. My expertise extends to popular frameworks like React and Vue.js, enabling me to build dynamic and interactive web applications that resonate with modern users. On the back end, I am well-versed in server-side scripting languages like Node.js and Python, coupled with a solid understanding of databases such as MongoDB and MySQL. This comprehensive skill set allows me to architect robust and scalable web solutions.`,
    ...
    experiences: [
        {
            ...
            date: '2023-2024',
            description: 'Senior Digital Business Development, and implemented/Enhancement everything from order management, worked a part of a multi-disciplinary team, solved issue from branches of the digital banking.',
            subDescription: [
